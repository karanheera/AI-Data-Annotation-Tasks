# Named Entity Recognition (NER) Annotation Showcase
...
The `data/` folder contains source text files used for annotation:
...
> ⚠️ **Note:** The text samples in `social_media_texts.csv` were **generated by giving prompts to ChatGPT** to create random raw social media-style texts suitable for NER annotation.
>
...
This NER Annotation Showcase demonstrates:
...
* **Efficient annotation workflow**: 100 samples annotated in ~1 hour.
